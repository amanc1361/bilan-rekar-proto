...
const (
	...
	BusinessService_GetBusiness_FullMethodName                     = "/business.v1.BusinessService/GetBusiness"
	BusinessService_UpdateBusiness_FullMethodName                  = "/business.v1.BusinessService/UpdateBusiness"
	BusinessService_DeleteBusiness_FullMethodName                  = "/business.v1.BusinessService/DeleteBusiness"
	BusinessService_ListBusinesses_FullMethodName                  = "/business.v1.BusinessService/ListBusinesses"
	...
	BusinessService_GetBusinessWithUsers_FullMethodName            = "/business.v1.BusinessService/GetBusinessWithUsers"
	...
	BusinessService_GetBusinessUsers_FullMethodName                = "/business.v1.BusinessService/GetBusinessUsers"
)
...
type BusinessServiceClient interface {
	...
	GetBusinessByName(ctx context.Context, in *GetBusinessByNameRequest, opts ...grpc.CallOption) (*GetBusinessResponse, error)
	...
	AddUserToBusiness(ctx context.Context, in *AddUserToBusinessRequest, opts ...grpc.CallOption) (*AddUserToBusinessResponse, error)
	RemoveUserFromBusiness(ctx context.Context, in *RemoveUserFromBusinessRequest, opts ...grpc.CallOption) (*RemoveUserFromBusinessResponse, error)
...
func (c *businessServiceClient) ListBusinesses(ctx context.Context, in *ListBusinessesRequest, opts ...grpc.CallOption) (*ListBusinessesResponse, error) {
	...
	err := c.cc.Invoke(ctx, BusinessService_ListBusinesses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *businessServiceClient) GetBusinessByName(ctx context.Context, in *GetBusinessByNameRequest, opts ...grpc.CallOption) (*GetBusinessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBusinessResponse)
...
func (c *businessServiceClient) AddUserToBusiness(ctx context.Context, in *AddUserToBusinessRequest, opts ...grpc.CallOption) (*AddUserToBusinessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *businessServiceClient) RemoveUserFromBusiness(ctx context.Context, in *RemoveUserFromBusinessRequest, opts ...grpc.CallOption) (*RemoveUserFromBusinessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BusinessServiceServer interface {
	...
	GetBusinessByName(context.Context, *GetBusinessByNameRequest) (*GetBusinessResponse, error)
...
func (UnimplementedBusinessServiceServer) GetBusinessByName(context.Context, *GetBusinessByNameRequest) (*GetBusinessResponse, error) {
...
func (UnimplementedBusinessServiceServer) AddUserToBusiness(context.Context, *AddUserToBusinessRequest) (*AddUserToBusinessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddUserToBusiness not implemented")
}
func (UnimplementedBusinessServiceServer) RemoveUserFromBusiness(context.Context, *RemoveUserFromBusinessRequest) (*RemoveUserFromBusinessResponse, error) {
