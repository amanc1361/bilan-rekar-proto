...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	...
	"\arole_id\x18\x05 \x01(\rR\x06roleId\x12\x1b\n" +
	...
	"\x0ehas_permission\x18\x01 \x01(\bR\rhasPermission2\xc0\x02\n" +
	"\vAuthService\x128\n" +
	"\x05Login\x12\x15.auth.v1.LoginRequest\x1a\x16.auth.v1.LoginResponse\"\x00\x12P\n" +
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponse\"\x00\x12M\n" +
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x1d.auth.v1.RefreshTokenResponse\"\x00\x12V\n" +
	"\x0fCheckPermission\x12\x1f.auth.v1.CheckPermissionRequest\x1a .auth.v1.CheckPermissionResponse\"\x00B\x8f\x01\n" +
